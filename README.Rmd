...
One day you might be able to install the released version of OPGgtheme from [CRAN](https://CRAN.R-project.org) with:
But you will not be able to do this for now
``` r
